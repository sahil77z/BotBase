...
sudo_usersx = ['-1001692430915', '-1001762193437', '-1001302611175', '-1001759306802', '-1001791775939']
...
app = Client(
    ...
    bot_token="5233741940:AAG1UBb-Dzhq7JIH616levMnNrUzvmAsBa0",
...
if __name__ == "__main__":
    ...
    app.send_message(chat_id=-1001669312015, text=f'Bot Restarted', disable_web_page_preview=True)
    cm1 = "BotCommand(f'/"
    cm2 = "','"
    cm3 = "')"
    ...
    if msgupd.msgupd != 'No New Update' :
      for i in range(len(sudo_usersx)):
        ...
        admin=app.get_chat_members(eval(sudo_usersx[i]))
        v=""
        for u in admin:
